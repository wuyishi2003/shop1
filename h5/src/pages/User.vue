<template>
    <div class="user">
        ...
        <yd-cell-group>
            <yd-cell-item type="div" @click.native="daili">
                <img slot="icon" src="../../static/image/h.png">
                <span slot="left">购买代理只需99元</span>
            </yd-cell-item>
            <yd-cell-item type="div" @click.native="daili">
                <img slot="icon" src="../../static/image/g.png">
                <span slot="left">果农订单系统</span>
            </yd-cell-item>
        </yd-cell-group>

<template>
    <div class="ordercell">
        <yd-cell-group>
            ...
            <yd-cell-item v-if="parseFloat(goods_amountdl)">
                <span slot="left">代理价格</span>
                <span slot="right" class="demo-list-price">￥{{ this.GLOBAL.formatMoney(goods_amountdl, 2, '') }}</span>
            </yd-cell-item>

            <yd-cell-item v-if="parseFloat(goods_wxsxf)">
                <span slot="left">微信手续费</span>
                <span slot="right" class="demo-list-price">￥{{ this.GLOBAL.formatMoney(goods_wxsxf, 2, '') }}</span>
            </yd-cell-item>
